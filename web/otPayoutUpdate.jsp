...
<center>   
<div class="container">
  <h2 class="text-center text-primary">OT Payout Schedule</h2>
    <div class="clear">&#x00A0;</div>
        <div class="clear">&#x00A0;</div>
     <s:form action="otPayoutupdate"  enctype="multipart/form-data" method="post" >  
     <table>
         <s:iterator value="otPayoutList">
             <td><s:select id="i" list="otList" name="form.wageId" value="%{wageDefinitions.wageId}" label="Wage Id"  cssClass="form-control form-group " headerKey="-1" headerValue=" --Select--" ></s:select></td> 
            
             <td><s:textfield id="i" size="90" name="form.payoutDays" value="%{payoutDays}" label="Payout Days" cssClass="form-control form-group" placeholder="Enter Payout Days"></s:textfield></td> 
    ...
    <br/><br/>
      ...
      <s:submit  value="Update"  cssClass="btn btn-default" align="center" ></s:submit>
           ...
           <div class="col-sm-6 text-center"> 
          <button type="button" class="btn btn-default" ><a href="otPayoutdisplay" style="text-decoration:none; color:black">Cancel</a></button>
          </div>
            </div> 
   </s:form>
</div>
